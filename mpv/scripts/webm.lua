...
local options = {
	...
	output_directory = [[/run/media/msnessas/SSD Arquivos/PHOTOSHOP/SCRAPS/MKV]],
	run_detached = false,
...
encode = function(region, startTime, endTime)
  ...
  if options.run_detached then
    ...
    os.remove(os.getenv("HOME") .. "/x264_2pass.log")
    os.remove(os.getenv("HOME") .. "/x264_2pass.log.mbtree")
